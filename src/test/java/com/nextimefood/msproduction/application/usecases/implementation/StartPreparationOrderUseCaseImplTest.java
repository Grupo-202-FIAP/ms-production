...
@DisplayName("Testes unitários para StartPreparationOrderUseCaseImpl")
class StartPreparationOrderUseCaseImplTest {
    ...
    @InjectMocks
    private StartPreparationOrderUseCaseImpl startPreparationOrderUseCase;
    ...
    @Test
    @DisplayName("Deve iniciar preparação do pedido com sucesso")
    void deveIniciarPreparacaoDoPedidoComSucesso() {
        // Given
        ...
        // When
        OrderEntity result = startPreparationOrderUseCase.execute(orderId);
    ...
    void deveLancarOrderNotFoundExceptionQuandoPedidoNaoForEncontrado() {
        ...
        OrderNotFoundException exception = assertThrows(
                ...
                () -> startPreparationOrderUseCase.execute(orderId)
        );
