...
@DisplayName("Testes unitários para ReadyOrderUseCaseImpl")
class ReadyOrderUseCaseImplTest {
    ...
    @InjectMocks
    private ReadyOrderUseCaseImpl readyOrderUseCase;
    ...
    @Test
    @DisplayName("Deve marcar pedido como ready com sucesso")
    void deveMarcarPedidoComoReadyComSucesso() {
        // Given
        ...
        // When
        OrderEntity result = readyOrderUseCase.execute(orderId);
    ...
    void deveLancarOrderNotFoundExceptionQuandoPedidoNaoForEncontrado() {
        ...
        OrderNotFoundException exception = assertThrows(
                ...
                () -> readyOrderUseCase.execute(orderId)
        );
