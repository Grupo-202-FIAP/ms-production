...
@DisplayName("Testes unitários para CompleteOrderUseCaseImpl")
class CompleteOrderUseCaseImplTest {
    ...
    @InjectMocks
    private CompleteOrderUseCaseImpl completeOrderUseCase;
    ...
    @Test
    @DisplayName("Deve completar pedido com sucesso")
    void deveCompletarPedidoComSucesso() {
        // Given
